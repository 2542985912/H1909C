				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveStu.htm" enctype="multipart/form-data">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>姓名:</td>
								<td><input type="text" id="username" name="sname"/></td>
							</tr>
							<tr>
								<td>性别:</td>
							<td>男<input type="radio" id="sex" name="sex"  value="男"/>
								女<input type="radio" id="sex" name="sex"  value="女"/></td>
							</tr>
							<tr>
								<td>头像:</td>
							...
							<tr><td>爱好:</td>
							<td>LOL<input type="checkbox" name="hobby" value="LOL"/>
								WOW<input type="checkbox" name="hobby" value="WOW"/>
								吃鸡<input type="checkbox" name="hobby" value="吃鸡"/>
								王者农药<input type="checkbox" name="hobby" value="王者农药"/></td>
							</tr>
							<tr>
								<td>生日:</td>
								<td><input type="date" id="bid" name="birthday"/></td>
							</tr>
							<tr>
								<td>班级:</td>
								<td colspan="4">
	           ...
	           // height: 500,                        //行高，如果没有设置height属性，表格自动根据记录条数觉得表格高度
	            ...
	            },
	            {
	                ...
	                formatter:function(value,row,index){
	                	return "<img src='"+value+"' height="50px" weight="50px"/>";
	                } */
	            },
	            {
	                field: 'hobby',
